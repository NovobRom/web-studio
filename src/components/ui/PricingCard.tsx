...
export function PricingCard({
  ...
  const { featured, price, currency, ctaUrl } = tier;

  return (
    <div
      className={`relative rounded-card p-10 transition-all duration-300 hover:-translate-y-1 ${
        featured
    ...
    >
      ...
      <p className="font-display text-5xl text-text leading-none mb-2">
      ...
      <a
        ...
        className={`block w-full py-3.5 text-center rounded-[var(--radius-pill)] font-semibold text-[0.9rem] no-underline transition-all duration-300 ${
          featured
